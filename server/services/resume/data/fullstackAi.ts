...
/**
 * Sprint 11: backend-side duplicate of src/components/resume/data/fullstack-ai.ts,
 * for the same "no frontend imports in the backend" reason resumeTypes.ts
 * documents. Content must stay identical to the frontend copy by hand —
 * verified verbatim against the user-supplied source resume
