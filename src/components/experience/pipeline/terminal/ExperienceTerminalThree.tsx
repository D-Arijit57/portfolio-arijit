 ...
 * header treatment, same Geist Mono chrome), so it reads as a third
 ...
 * own root) — the same typeface and highlighting every other rendered
 * source file in this workspace already uses. `file.content` is the
 * genuine VFS content for americanchase.yaml — nothing here is a second
 * copy of it.
 */
